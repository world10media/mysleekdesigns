        ...
        <article class="body-content">
            <div class="row container">
                <div class="small-12 columns">
                    ...
                    <hr>
                    <p class="text-center body-content md-padding">Get the right care coverage for you and your family with the features, benefits and low rates you want. We will help you find a personalized health plan by working with you to determine your needs and then finding the plan that best fits your budget and meets your needs. We partner with the nation’s leading insurance carriers to offer health plans that provide exceptional coverage, protection and value at affordable prices. After all, you don’t want to sacrifice quality for cost or compromise on coverage. We make insurance easy, quick, and painless because we believe health insurance should not be complicated or intimidating.</p>
                    <a href="form.php" type="button" class="secondary button body-content-button md-padding">See Plans</a>
                </div>
            </div>
        </article>
        <!-- end main -->
