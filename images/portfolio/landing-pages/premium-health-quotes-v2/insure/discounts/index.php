            ...
            <div class="row container">
                <div class="small-12 columns">
                    ...
                    <p class="text-center body-content md-padding">Get the right care coverage for you and your family with the
                        ...
                        believe health insurance should not be complicated or intimidating.</p><input type="submit" form="form1"
                                                                                                      onclick="" id="submit"
                                                                                                      value="See Plans"
                                                                                                      class="secondary button body-content-button md-padding"/>
                </div>
            </div>
        </article>
                ...
                <div class="small-12 columns">
                    ...
                    <div class="row container">
                        ...
                        <div class="small-12 medium-12 large-7 columns body-list-right-side">
                            ...
                            <ul class="main-list">
                                <li>You may qualify for federal subsidies that can help reduce premiums, co-pays, coinsurance,
                                    and deductibles.
                                </li>
                                <li>You or your child may qualify for free or low-cost coverage through Medicaid or the
                                    Children’s Health Insurance Program (CHIP).
                                </li>
                                <li>If you’re under 26 you may be able to stay on your parent’s health insurance plan.</li>
                                <li>If you’re under 30, you may be able to purchase a ‘catastrophic’ coverage plan with a high
                                    deductible, low premium plan.Catastrophic plans are the cheapest plan that
                                    qualifies as minimal essential coverage. These plans cover emergencies, which, if you’re a
                                    healthy individual, is all you may need.
                                </li>
                                <li>If you own a small business with fewer than 25 employees, you may qualify for the small
                    ...
                    <div class="row" style="font-weight: 400">
                        <div class="small-12 medium-10 medium-offset-1 columns"><p class="body-content">Consult a licensed
                            insurance professional to learn more about ways you can lower your health insurance costs and get a
                            plan that works for you.</p> 
                            <button class="secondary button body-content-button md-margin-top"
                                    onclick="window.location.href='../discounts/form.php'">Get Your Quotes</button>
                        </div>
                    </div>
                </div>
            </div>
