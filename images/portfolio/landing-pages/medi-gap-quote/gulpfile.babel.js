...
function copy() {
    return gulp.src(PATHS.assets)
        ...
        .pipe(gulp.dest('../medigapquote.org/assets'));
}

// Copy page templates into finished HTML files
function pages() {
    return gulp.src('src/pages/**/*.{php,hbs,handlebars}')
        .pipe(panini({
            root: 'src/pages/',
            layouts: 'src/layouts/',
...
function sass() {
    return gulp.src('src/assets/scss/app.scss')
        ...
        .pipe(gulp.dest('../medigapquote.org/assets/css'))
...
function javascript() {
    return gulp.src(PATHS.javascript)
        ...
        .pipe(gulp.dest('../medigapquote.org/assets/js'));
}
...
function images() {
    return gulp.src('src/assets/img/**/*')
        ...
        .pipe(gulp.dest('../medigapquote.org/assets/img'));
}
...
function watch() {
    ...
    gulp.watch('src/pages/**/*.php', gulp.series(pages, reload));
    /* SIMON LACEY added this for php */
    gulp.watch('src/{layouts,partials}/**/*.html', gulp.series(resetPages, pages, reload));
    gulp.watch('src/{layouts,partials}/**/*.php', gulp.series(resetPages, pages, reload));
    /* SIMON LACEY added this for php */
    gulp.watch('src/assets/scss/**/*.scss', sass);
