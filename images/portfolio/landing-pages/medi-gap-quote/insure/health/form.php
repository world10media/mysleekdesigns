            ...
            <form id="medicare" name="form1" role="form" action="../../assets/php/process2.php" method="post">
                ...
                <div class="row">
                    <div class="small-12 columns">
                        <h3 class="form-header" id="form_title">Fill in this short medicare form then click view plans.</h3>
                ...
                <div class="row">
                    <div class="small-12 medium-8 columns">
                        <p class="terms">By clicking "View Plans" I provide my signature, expressly authorizing MediGapQuote or one of these <a href="carriers.php" target="_blank" style="text-decoration:underline;">carriers</a>
