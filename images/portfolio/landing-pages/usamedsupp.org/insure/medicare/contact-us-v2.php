...
<!-- start hero -->
<div class="hero-contact-v2">
    <div class="row">
        <div class="overlay"></div>

        <div class="contact-form-container-v2">
            <div class="small-12 medium-12 large-12 columns">

                <form class="contact-form-v2" id="contact-us" name="form1" role="form"
                        ...
                        <div class="large-12 columns">
                            <label for="crequest">Message:
                                <select id="crequest" name="crequest" required class="required">
                                    ...
                                    <option value="partner">I want to partner with usamedsupp.org in some way.</option>
                                    <option value="mediaInquiry">I have a media inquiry for usamedsupp.org.</option>
                                    <option value="noContact">I want usamedsupp.org to stop contacting me.</option>
