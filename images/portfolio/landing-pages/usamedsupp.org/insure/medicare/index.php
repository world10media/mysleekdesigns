...
<div class="hero">
    <div class="row">
        ...
        <div class="small-12 medium-12 columns hero-content">
            ...
            <ul class="hero-list">
                <li><img class="hero-list-circles-numbers" src="../../assets/img/circles-numbers-1.png" alt="1"> Fill out our form</li>
                    ...
                    <div class="small-10 medium-5 columns">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-button">
                                <input type="submit" class="button" id="hero-zip-submit-button" value="See Plans">
                            </div>
                        </div>

                        <!-- todo hugo i replaced the form in hero with the one above. please make sure it works. thanks. -->
                        <!--<label>
                            <input type="tel" id="hero-zip-submit-input" name="zip" pattern="\d{5}"  value="33020" placeholder="Enter your zip code...">
                        </label>
                            <button id="hero-zip-submit-button" type="submit" class="button">Start Quote <i class="fi-play"></i></button>-->
                    </div>
                </div>
            </form><!-- end hero form -->
    ...
    <div class="row" id="carrier-logos">
        <div class="small-12 medium-12 columns">
            <div class="owl-carousel">
                ...
                <div><img src="../../assets/img/carriers/aarp.jpg" alt="aarp"></div>
                ...
                <div><img src="../../assets/img/carriers/united-health-one.jpg" alt="united health care medicare solutions"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="what-is-medigap">
    <div class="row">
        <div class="small-12">
            <h3>What is Medicare Supplement Insurance?</h3>
            <hr>
            <p class="text-center">Medicare Supplement Insurance, or Medigap as it’s often called, can help pay some of the health care costs that Medicare does not cover,
...
<div id="short-form-enter-zip">
    <div class="column row">
        <h2 id="short-form-title">Find a Medicare plan that fits your needs!</h2>
...
<!-- end faqs -->
<div class="column row">
    <div class="small-12 medium-5 large-5 columns small-centered medium-centered">
