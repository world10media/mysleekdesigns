            ...
            <form id="medicare" name="form1" role="form" action="../../assets/php/process2.php" method="post">
                ...
                <div class="row">
                    <div class="small-12 columns">
                        <h3 class="form-header" id="form_title">Fill in this short medicare form and click get quotes.</h3>
                ...
                <div class="row">
                    <div class="small-12 medium-8 columns">
                        <p class="terms">By clicking "Get Quotes" I provide my signature, expressly authorizing USAMedSupp or one of these <a href="carriers.php" target="_blank" style="text-decoration:underline;">carriers</a>
                            ...
                            may revoke my consent at any time. To speak directly to a representative for a quote, please call usamedsupp.org at 1-877-386-9926. By using
