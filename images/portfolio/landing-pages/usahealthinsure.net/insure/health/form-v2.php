...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>USA Health Insure</title>

    <meta name="description" content="USA health insurance for the masses">
    <meta name="keywords" content="usa health insurance">
    <meta name="author" content="simon lacey">
    ...
    <link rel="stylesheet" href="css/styles-form-v2.css">
...
if ($phone_number == '') {
    ...
    $phone_number = get_phone($offer_id, $aff_id, $aff_sub, $default_phone);
}
?>
...
<body>
  ...
  <!-- Google Tag Manager -->
  <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-5VR9WX"
  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
  j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
  '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  })(window,document,'script','dataLayer','GTM-5VR9WX');</script>
    ...
    <nav class="navbar" id="main-navbar">
        <div class="container">
            ...
            <div class="navbar-header col-md-4 8 col-sm-3 col-xs-4 pull-left">
                <a class="navbar-brand smooth-scroll"><img src="imgs/logo.png" class="logo-b" alt="logo"></a>
            </div>
            ...
            <div class="col-md-8 col-sm-9 col-xs-8 navbar-right pull-right speak-agent">
                <div class="pull-right">
                    ...
                    <a class="phone" href="tel:+<?php echo $phone_number; ?>"><strong><?php echo $phone_number; ?></strong></a>
                </div>
            </div>
...
<div class="container form-container">
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-header">
                <h2 id="form_title">The Fastest Way To Get Free <?php if ($_POST['insurance_type'] == 'medicare') { echo 'Medicare';} else {echo 'Health';};?> Insurance Quotes</h2>

                <p class="intro">Please enter your information below to be connected to an agent.</p>
            </div>
        </div>
    </div>
    <!-- form wrap -->
    ...
    <form id="form1" name="form1" class="form-inline" role="form" action="../../process.php" target="actionform" method="post">
            ...
            <div class="personal-form">
                <div class="row">
                    <div class="col-md-12 personal-info">
                        ...
                        <!-- todo change bday input, use input mask -->
                        <!--<div class="inputWrapp">
                            <label class="quest">Birthdate <span class="tag">(mm/dd/yyyy)</span></label>
                            <input class="dob" type="text" name="applicant_dob" id="applicant_dob" maxlength="10" data-type="birthdate" data-message="Type the date with the format: mm/dd/yyyy." value="mm/dd/yyyy" tabindex="6">
                        </div>-->


                        <div class="form-group col-md-7 col-sm-12" id="birthday_selects">
                            ...
                            <select id="DateOfBirth_Year" name="DateOfBirth_Year" required class="required">
                                ...
                                <option <?php if ($_POST['insurance_type'] == 'medicare') { echo 'selected';}?>
                        ...
                        <div id="medial_conditions" class="container medical-history">
                            <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                    ...
                                    <label class="radio-inline">
                                        <!--<input onclick="show()" id="lb_conditions" type="radio" name="health" class="required" value="Y"> Yes-->
                                        <input onclick="show()" id="lb_conditions" required type="radio" name="health"
                                               class="required" title="Please choose either Yes or No."
                                               value="Y"><span>Yes</span>
                                    </label>
                                    <label class="radio-inline">
                                        <!--<input onclick="h_conditions()" id="lb_conditions2" type="radio" name="health" class="required" value="N"> No-->
                                        <input onclick="h_conditions()" id="lb_conditions2" type="radio" name="health"
                                               class="required" title="Please choose either Yes or No." value="N" checked="checked"><span>No</span>
                                    </label>
                                </div>
                            </div>
                                            ...
                                            <div class="conditions-checklist-holder">
                                                ...
                                                <div class="col-md-2 col-sm-3">
                                                    <ul class="checklist" style="">
                                                        ...
                                                        <li>
                                                            <input class="health-conditions-list" id="cancer" name="cancer"
                                                                   type="checkbox" value="Y"/>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <label class="radio-inline">
                                        <input id="lb_insured2" type="radio" name="insured" class="required" value="N" checked="checked">
                                        <span>No</span>
                                    </label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <label class="radio-inline">
                                        <input id="medications2" type="radio" name="medications" class="required" value="N" checked="checked">
                                        <span>No</span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        ...
                        <input type="tel" class="required" id="zip" required name="zipcode" pattern="\d{5}" value="<?php echo $_POST['zip']; ?>"
        ...
        <div class="row terms-container">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 pull-right">
                <button type="submit" class="btn btn-shadow btn-green" style="font-size:20px;">Continue <span
            ...
            <div class="col-md-8 col-xs-12 push-left">
                <p class="terms">By clicking "Continue" I provide my signature, expressly authorizing USA Health
                    Insurance or one of these <a href="../carriers/"
                                                 target="_blank"
                                                 style="text-decoration:underline;">carriers</a> to contact
                    ...
                    usahealthinsure.net at 1-877-386-9926. By using this form, you agree to the terms of our <a
                        href="#modal-privacy" class="privacy-info-link" data-toggle="modal" style="">Privacy
                        Policy</a>.</p>
            </div>
        </div>
...
<div class="row footer">
    <div class="col-md-12 col-sm-12 privacy">
        <p><a href="#modal-privacy" class="" data-toggle="modal">Privacy Policy</a> | <a href="#modal-terms"
            ...
            <br>Copyright &copy; 2016 | Usahealthinsure.net | All Rights Reserved</p>
    </div>
</div>
<!-- Modal HTML -->
...
<!-- Offer Goal Click: AHI Email Zip Submits -->
<img src="http://hbcinsure.go2cloud.org/GH3N?transaction_id=<?php echo $_POST["transaction_id"]; ?>" width="1" height="1" />
<!-- // End Offer Goal Click -->

<!-- Offer Goal Click: AHI Display Zip Submits -->
<img src="http://hbcinsure.go2cloud.org/GH3T?transaction_id=<?php echo $_POST["transaction_id"]; ?>" width="1" height="1" />
<!-- // End Offer Goal Click -->
...
<script type="text/javascript" src="js/main-long.js"></script>
...
<div class="hidden">
    <iframe name="actionform" id="actionform" src="" frameborder="0"></iframe>
</div>
...
<script>
    $('#state').val("<?php echo $city_state['state'];?>")
</script>
...
<!-- Library for inputmask in phone number input -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.inputmask/3.1.62/jquery.inputmask.bundle.js"></script>

<!-- InputMask for phone number input field -->
<script>
