...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/uhi-form.css">
    <!--
        ...
        <div class="row terms-container">
            ...
            <div class="col-md-8 col-xs-12 push-left">
                <p class="terms">By clicking "Continue" I provide my signature, expressly authorizing USA Health
                    Insurance or one of these <a href="../carriers/" target="_blank" style="color:#666;text-decoration:underline;">carriers</a> to contact
                    ...
                    www.usahealthinsure.net at 1-877-386-9926. By using this form, you agree to the terms of our <a
                        href="#modal-privacy" class="privacy-info-link" data-toggle="modal"
                        style="color:#666;text-decoration:underline;">Privacy
                        Policy</a>.</p>
            </div>
        </div>
...
<div class="row footer">
    <div class="col-md-12 col-sm-12 privacy">
        <p><a href="#modal-privacy" class="" data-toggle="modal">Privacy Policy</a> | <a href="#modal-terms"
            ...
            <br>Copyright &copy; 2016 | www.usahealthinsure.net | All Rights Reserved</p>
    </div>
</div>
<!-- Modal HTML -->
