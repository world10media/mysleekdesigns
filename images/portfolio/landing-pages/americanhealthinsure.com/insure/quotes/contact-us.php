<?php
include('../../assets/php/env-ahiv2.php');
...
<head>
    ...
    <title>AmericanHealthInsure - Affordable Health and Medicare Insurance - <?php echo $aff_ref; ?></title>
    ...
    <div class="column row">
        ...
        <div class="small-6 medium-6 columns text-right">
            <div class="contact-number-wrapper">
                ...
                <a class="header-toll-free-number hide-for-small-only" href="tel:'.$phone_number.'">'.$phone_number.'</a>
                <a href="tel:'.$phone_number.'"><img class="icon-mobile-phone" src="../../assets/img/icon-phone-blue.svg" alt="phone icon"></a>
            </div>
        </div>
        ';};?>
...
<div class="contact-us">
    <div class="row">
        <div class="small-12 columns contact-form-wrapper">
            <div class="row">
                <div class="small-12 medium-8 columns contact-input-section">
                    <form class="contact-form" id="contact-us" name="form1" role="form"
                        ...
                        <div class="row">
                            <div class="small-12 columns">
                                <h3 class="contact-form-header">Contact Us</h3>
                                <p class="contact-form-subheader">Fill out the short form below then click Send Message button. We will respond back to you as soon as we can.</p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="small-12 medium-6 columns">
                                <label for="crequest">How Can We Help You: <span class="required">*</span>
                                    <select id="crequest" name="crequest" required class="required">
                                        <option value="">What are you looking for?</option>
                                        <option value="partner">I want to partner with americanhealthinsure.com in some way.</option>
                                        <option value="mediaInquiry">I have a media inquiry for americanhealthinsure.com.</option>
                                        <option value="noContact">I want americanhealthinsure.com to stop contacting me.</option>
                            ...
                            <div class="small-12 medium-8 large-6 columns">
                                <button class="button secondary float-right contact-send-message-button" type="submit">Send Us Your Message</button>
                            </div>

                        </div>
                    </form>
                </div>
                <div class="small-12 medium-4 columns contact-company-info">

                    <p class="contact-info"><span class="contact-info-first contact-form-info-header">Email:</span>info@americanhealthinsure.com</p>
                    <p class="contact-info contact-info-last"><span class="contact-form-info-header">Address:</span>
                        Health Insurance Services Legal<br>
                        2 Oakwood Blvd.<br>
                        Suite 100<br>
                        Hollywood, FL 33020 </p>

                    <img class="contact-form-info-last" src="../../assets/img/contact-us-agent.jpg" alt="agent">
                </div>
            </div>
        </div>
    </div>
...
<footer class="site-footer">
    <div class="row">
        <div class="small-12 medium-6 columns footer-copyright">Copyright &copy; AmericanHealthInsure, All rights reserved.</div>

        <div class="small-12 medium-6 columns footer-privacy">
        ...
        <div class="reveal" id="privacy-policy" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out">
            <div class="row">
                <div class="small-12 columns">
                    ...
                    <p class="modal-body">AmericanHealthInsure, through its www.americanhealthinsure.com website (“Site”) is committed to ensuring the privacy and security of each user that visits our
                        ...
                        We have established this www.americanhealthinsure.com Privacy Policy so you know the importance we place on your privacy and so you can understand how we collect and use information
                        ...
                        you by telephone. By using our service to request information from our advertising clients and advertising partners, you are giving permission to www.americanhealthinsure.com and these
                        parties (or
                        ...
                        <span class="lead">Opt-Out of Receiving Communications from www.americanhealthinsure.com</span>
                        ...
                        This Site may contain links that direct you to websites owned and operated by other companies. www.americanhealthinsure.com does not control or endorse these websites, and we do not
                        assume any
                        ...
                        www.americanhealthinsure.com may change this Privacy Policy at any time. Should we revise this Privacy Policy in the future, we will immediately publish the amended Privacy Policy on our
                        website. We
                        ...
                        Emailing us at: privacy@americanhealthinsure.com <br><br>
        ...
        <div class="reveal" id="terms-of-use" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out">
            <div class="row">
                <div class="small-12 columns">
                    ...
                    <p class="modal-body">The www.americanhealthinsure.com website (“www.americanhealthinsure.com” or the “Site”) is owned and operated by www.americanhealthinsure.com. By
                        ...
                        PLEASE READ THESE TERMS CAREFULLY.<strong> THEY CONTAIN A MANDATORY ARBITRATION PROVISION AND CLASS ACTION
                            WAIVER.</strong>
                        <br><br>
                        www.americanhealthinsure.com may revise and update these Terms at any time. Your continued usage of the Site will mean you
                        accept those changes. <br><br>
            
                        <span class="lead">Use of the Website</span>
                        By using the Site, you represent to www.americanhealthinsure.com that 1) you are authorized to enter into this Agreement and
                        ...
                        infringes the rights of www.americanhealthinsure.com or any third party; (3) any
                        information
                        or data provided to www.americanhealthinsure.com by you will not violate any law or regulation or infringe the rights of www.americanhealthinsure.com or any third party; (4) all information that you
                        ...
                        prior express written permission of www.americanhealthinsure.com and/or its
                        ...
                        message or transmittal you send to www.americanhealthinsure.com on or through the
                        ...
                        negatively impact www.americanhealthinsure.com. The licenses granted by www.americanhealthinsure.com terminate if you do not comply with these
                        Terms. <br><br>
            
                        The material, images, and text on the Site (“Content”) is protected by copyright under both United States
                        and foreign laws. Title to the Content remains with www.americanhealthinsure.com
                        or its
                        ...
                        subject to change or termination without notice in the editorial discretion of www.americanhealthinsure.com. All rights not
                        expressly granted herein are reserved to www.americanhealthinsure.com and its
                        ...
                        jurisdiction of
                        www.americanhealthinsure.com and its suppliers. Accordingly, www.americanhealthinsure.com assumes no liability for or relating to the delay,
                        ...
                        MOREOVER, www.americanhealthinsure.com MAY MAKE MODIFICATIONS ANY/OR CHANGES ON THIS SITE OR IN THE MATERIALS AND INFORMATION
                        AVAILABLE ON THIS SITE AT ANY TIME AND FOR ANY REASON.
                        www.americanhealthinsure.com MAKES NO REPRESENTATIONS, GUARANTEES, OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE
                        SUITABILITY, COMPLETENESS, TIMELINESS, RELIABILITY, LEGALITY,
                        OR ACCURACY OF
                        THE www.americanhealthinsure.com SERVICES OR THE INFORMATION, CONTENT, MATERIALS, PRODUCTS, OR OTHER SERVICES, OR INCLUDED ON
                        OR OTHERWISE MADE AVAILABLE ON THE SITE. YOU EXPRESSLY AGREE
                        THAT YOUR USE OF THE SITE IS AT YOUR OWN RISK. TO THE FULLEST EXTENT PERMISSIBLE BY APPLICABLE LAW, www.americanhealthinsure.com DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING
                        BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, AND FITNESS FOR PARTICULAR
                        PURPOSE. www.americanhealthinsure.com DOES NOT WARRANT THAT THE INFORMATION,
                        CONTENT, MATERIALS, PRODUCTS OR OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE
                        SITE, www.americanhealthinsure.com’s SERVERS, OR ELECTRONIC COMMUNICATIONS SENT
                        FROM www.americanhealthinsure.com ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. www.americanhealthinsure.com ALSO MAKES NO REPRESENTATION,
                        GUARANTEE, OR WARRANTY THAT THIS WEBSITE WILL OPERATE ERROR FREE
                        OR IN AN UNINTERRUPTED FASHION. <br><br>
            
                        To the maximum extent permitted by law, in no event shall www.americanhealthinsure.com, its licensors, its suppliers, or any
                        ...
                        information, Content, materials, or www.americanhealthinsure.com services included on or otherwise made available to you
                        through the Site, whether based in contract, tort, strict
                        liability, or otherwise, and whether or not www.americanhealthinsure.com, its licensors, its suppliers, or any third parties
                        mentioned on the Site have been advised of the possibility of
                        such damages www.americanhealthinsure.com, its licensors, its suppliers, or any third parties mentioned on the Site shall be
                        ...
                        business information, idea, concept or invention to www.americanhealthinsure.com by email, you automatically grant-or warrant
                        that the owner of such content or intellectual property has
                        expressly granted www.americanhealthinsure.com a royalty-free, perpetual, irrevocable, sublicensable world-wide nonexclusive
                        ...
                        proprietary, do not submit them to the Site or to www.americanhealthinsure.com
                        by email.<br><br>
            
                        <span class="lead">Advertisements, Searches, and Links to Other Sites</span>
                        www.americanhealthinsure.com may provide links to third-party websites. www.americanhealthinsure.com also may select certain websites as priority
                        responses to search terms you enter and
                        www.americanhealthinsure.com may agree to allow advertisers to respond to certain search terms with advertisements or sponsored
                        content. obamacareusa.org does not endorse the content on
                        any third-party websites. www.americanhealthinsure.com is not responsible for the content of linked third-party sites, sites
                        ...
                        notice at any time. www.americanhealthinsure.com may add, modify, or delete any
                        ...
                        The AAA Rules are available at www.adr.org or by calling 1-800-778-7879. If you initiate arbitration, www.americanhealthinsure.com will promptly reimburse you for any standard filing fee
                        which may have been required under AAA Rules once you have notified www.americanhealthinsure.com in writing and provided a copy
                        of the arbitration proceedings. However, if www.americanhealthinsure.com is
                        the prevailing party in the arbitration, applicable law may allow the arbitrator to award attorneys’ fees
                        and costs to www.americanhealthinsure.com. If for any reason the AAA is
                        ...
                        ONLY BRING CLAIMS AGAINST www.americanhealthinsure.com IN AN INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY
                        ...
                        by contacting www.americanhealthinsure.com’s copyright agent (identified below) and providing the following information:
                        <br><br>
                        ...
                        Email: privacy@www.americanhealthinsure.com<br><br>
            
                        <span class="lead">Complete Agreement</span>
                        Except as expressly provided in a particular “legal notice” on the Site or via e-mail from www.americanhealthinsure.com, this
                        Agreement and the www.americanhealthinsure.com Privacy Policy constitute the
                        entire agreement between you and www.americanhealthinsure.com with respect to the use of the Site and Content. <br><br>
                        ...
                        &copy; 2016 www.americanhealthinsure.com, All rights reserved.
                    </p>
                    <a class="button large close-modal" data-close>Close</a>
