...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/ahi_index_v2.min.css">
    ...
    <link rel="stylesheet" href="../../assets/css/fonts-lato.css">-->
        ...
        <div class="container">
            <div class="row y-middle">
                ...
                <div
                    ...
                    <a href="tel:'.$phone_number.'" class="btn btn-shadow btn-green"><span class="glyphicon glyphicon-phone"
                                                                                 aria-hidden="true"></span>'.$phone_number.'
                    </a>
                </div>
                    ';};?>
