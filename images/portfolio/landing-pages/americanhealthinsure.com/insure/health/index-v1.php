...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/ahi_index.css">
...
============================== -->
    <section id="hero9" class="bg-img hero-leadbox content-align-md"
             style="background-image:url('../../assets/imgs/hero.jpg');">
        <div class="overlay"></div>

        <div class="container">
            <div class="row y-middle">
                <!-- Intro Text -->
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7 center-md text-white hidden-sm hidden-xs">
                    <h1>Find Health Insurance that works with your budget.</h1>
						<span class="advantages">

                        <ul class="free-quote-list hidden-sm hidden-xs">
                            <li><span class="glyphicon glyphicon-check" aria-hidden="true"></span>Free Quotes</li>
                            <li><span class="glyphicon glyphicon-check" aria-hidden="true"></span>Compare Plans</li>
                            <li><span class="glyphicon glyphicon-check" aria-hidden="true"></span>Save Time and Money
                            </li>
                            <li><span class="glyphicon glyphicon-check" aria-hidden="true"></span>Leading Carrier Plans
                            </li>
                            <li><span class="glyphicon glyphicon-check" aria-hidden="true"></span>Low Affordable
                                Premiums
                            </li>
                            <li><span class="glyphicon glyphicon-check" aria-hidden="true"></span>Prescription Drug
                                Coverage
                            </li>
                        </ul>
						</span>
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    ...
                    <form action="form.php" method="post"
                        ...
                        <h4 class="text-center free-quote">Free Online Quote</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group enter-zip">
                                    <button type="submit" id="submit" class="btn btn-shadow btn-red">Start My Free Quote <span
