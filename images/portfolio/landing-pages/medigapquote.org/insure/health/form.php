...
<div id="preloader" style="position: fixed;
            ...
            overflow: visible;
            opacity: 0.95;
            background: rgba(255,255,255,0.2) url('./../../assets/img/preloader.gif') no-repeat center center;"></div>
<div class="mdq-form">
    <div class="row">
            ...
            <form id="medicare" name="form1" role="form" action="../../assets/php/process2.php" method="post">
                ...
                <div class="row">
                    <div class="small-12 columns">
                        <h3 class="form-header" id="form_title">Fill in this short medicare form then click get quotes.</h3>
                ...
                <div class="row">
                    <div class="small-12 medium-8 columns">
                        <p class="terms">By clicking "Get Quotes" I provide my signature, expressly authorizing MediGapQuote or one of these <a href="carriers.php" target="_blank" style="text-decoration:underline;">carriers</a>
                            ...
                            may revoke my consent at any time. To speak directly to a representative for a quote, please call medigapquote.org at 1-877-386-9926. By using
                            this form, you agree to the terms of our <a data-toggle="privacy-policy" style="">Privacy Policy</a>.</p>
                    </div>
                    <div class="small-12 medium-4 columns">
                        <button class="button button-submit-form" type="submit">Get Quotes <i class="fi-play"></i></button>
                    </div>
                </div>
