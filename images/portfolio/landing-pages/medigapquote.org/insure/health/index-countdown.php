...
<head>
    ...
    <title>MediGapQuote - Affordable Medicare Insurance - <?php echo $aff_ref; ?></title>
    ...
    <!--    <script src="https://use.typekit.net/dig3ywx.js"></script>
        <script>try {
    ...
    <div class="column row">
        ...
        <div class="small-6 medium-6 columns text-right">
            <div class="contact-number-wrapper">
                ...
                <a href="tel:<?php echo $phone_number; ?>"><img class="icon-mobile-phone" src="../../assets/img/icon-phone-blue.png" alt="phone icon"></a>
            </div>
        </div>
...
<div class="hero">
    <div class="row">
        ...
        <div class="small-12 medium-12 columns hero-content">

            <!-- start hero content  -->
            <div class="hero-callout">
                <h1 class="hero-header"><span class="hero-header-callout">Compare</span> Medicare Quotes</h1>
                <p class="hero-subheader">... in three simple steps.</p>
            </div>
            <ul class="hero-list">
                <li><img class="hero-list-circles-numbers" src="../../assets/img/circles-numbers-1.png" alt="1"> Fill out form</li>
                <li><img class="hero-list-circles-numbers" src="../../assets/img/circles-numbers-2.png" alt="2"> Compare Plans</li>
                <li><img class="hero-list-circles-numbers" src="../../assets/img/circles-numbers-3.png" alt="3"> Save Time & Money!</li>
            </ul><!-- end hero content -->

            <!-- start hero form-->
            <form action="form.php" id="form1" method="post" class="hero-zip-submit">
                <div class="row">
                    <div class="small-10 medium-5 columns">
                        ...
                        <div class="input-group">
                            <input type="tel" class="input-group-field" id="hero-zip-submit-input" name="zip" pattern="\d{5}"  value="<?php echo $zip; ?>" placeholder="Enter your zip code...">
                            <div class="input-group-button">
                                <input type="submit" class="button" id="hero-zip-submit-button" value="Start Quote">
                            </div>
                        </div>
...
<div class="countdown-container">
    <div class="row">
        <div class="small-12 columns">
            <h3><span class="countdown-cta">Special Open Enrollment Period</span>
                <span class="countdown-cta-break">Get Your Free Medicare Quote Now until December 7th</span>
            </h3>
        </div>
    </div>
    <div class="row">
        <div class="small-12 columns">
            <div class="center">
                <h3 class="countdown-actnow">Act Now Before Time Is Up!</h3>
                <div class="clock clock-medicare"></div>
            </div>
        </div>
    </div>
</div>
...
<!-- start main -->
<div class="what-is-medigap countdown-mods">
    <div class="row">
        <div class="small-12">
            <h3>What is Medigap Insurance?</h3>
            <hr>
            <p class="text-center">Medicare Supplement Insurance, or Medigap as it’s often called, can help pay some of the health care costs that Original Medicare does not cover,
                such as copayments, coinsurance, and deductibles. Medigap covers any gaps in coverage that would normally require you to pay out-of-pocket when Medicare falls
                short. Typically, Medicare will pay its share of the Medicare-approved amount for a service and then Medigap pays its share so that the expense is paid in full. A
                Medigap policy is particularly valuable for seniors that live on fixed budgets and need to limit their expenses.</p>
        </div>
    </div>
</div>
<!-- end main -->
    ...
    <div class="row" id="carrier-logos">
        <div class="small-12 medium-12 columns">
            <div class="owl-carousel">
                <div><img src="../../assets/img/carriers/aetna.jpg" alt="aetna"></div>
                <div><img src="../../assets/img/carriers/anthem.jpg" alt="anthem"></div>
                <div><img src="../../assets/img/carriers/cigna.jpg" alt="cigna"></div>
                <div><img src="../../assets/img/carriers/fidelity-life.jpg" alt="fidelity life"></div>
                <div><img src="../../assets/img/carriers/health-net.jpg" alt="health net"></div>
                <div><img src="../../assets/img/carriers/humana.jpg" alt="humana"></div>
                <div><img src="../../assets/img/carriers/united-health-one.jpg" alt="united health one"></div>
            </div>
        </div>
    </div>
</div>
<!-- end carriers slider -->
<!-- start short form -->
<div id="short-form-enter-zip">
    <div class="column row">
        <h2 id="short-form-title">Find Medicare Plans that fit your needs!</h2>
        <form action="form.php" method="post" class="short-form-zip-submit">
            <div class="row">
                <div class="small-12 medium-5 small-centered columns">
                    <div class="input-group">
                        <label for="zip"></label>
                        <input class="input-group-field" type="tel" id="zip" name="zip" value="<?php echo $zip; ?>" placeholder="Enter your zip code...">
                        <div class="input-group-button">
                            <input type="submit" id="submit" class="button find-plans" value="Find Plans" onclick="document.getElementById('form1').submit();">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="faqs">
    <div class="row">
        <div class="small-12 columns text-center">
            ...
            <hr>
            <h4>What is Medicare Supplemental Insurance?</h4>
            <p>Medicare Supplement Insurance, or Medigap as it’s often called, can help pay some of the health care costs that Original Medicare does not cover, such as copayments,
                coinsurance, and deductibles. Medigap covers any gaps in coverage that would normally require you to pay out-of-pocket when Medicare falls short. Typically,
                Medicare will pay its share of the Medicare-approved amount for a service and then Medigap pays its share so that the expense is paid in full. A Medigap policy is
                particularly valuable for seniors that live on fixed budgets and need to limit their expenses.</p>
            <hr>
            <h4>Why do I need Medicare Supplemental Coverage?</h4>
            <p>Medicare Supplemental, or Medicare, coverage can help to cover costs that are not covered by Medicare, such as copays, deductibles, and coinsurance. Medigap coverage
                can protect your finances by paying expenses that you would be required to pay out of pocket.</p>
        </div>
    </div>
</div>
<!-- end faqs -->
<div class="column row">
    <div class="small-12 medium-7 large-5 columns small-centered medium-centered">

        <div class="phone-zip-module">
            <div class="phone-module">
                <h5>Speak with an agent now</h5>
                <span><a class="module-phone-cta" href="tel:<?php echo $phone_number; ?>">
                    <img class="phone-icon" src="../../assets/img/icon-phone-orange.png" alt="phone icon"><?php echo $phone_number; ?></a>
                </span>

            </div>
            <hr>
            <div class="email-module">
                <h5>or compare plans online</h5>
                <button class="button compare-plans" onclick="document.getElementById('form1').submit();">Compare Plans <i class="fi-play"></i></button>
            </div>
        </div><!-- end module -->
...
<footer class="footer">
    <div class="column row">
        <div class="small-12 medium-4 columns footer-copyright">Copyright &copy; MediGapQuote, All rights reserved.</div>
        <div class="small-12 medium-4 columns footer-address">2 Oakwood Blvd, Suite 100, Hollywood, FL, 33020</div>
        <div class="small-12 medium-4 columns footer-privacy"><a data-toggle="privacy-policy">Privacy Policy</a>&nbsp;|&nbsp;<a
        ...
        <div class="reveal" id="privacy-policy" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out">
            <div class="columns row">
                <div class="small-12">
                    ...
                    <hr>
                    <p>MediGapQuote, through its www.medigapquote.org website (“Site”) is committed to ensuring the privacy and security of each user that visits our
                        ...
                        We have established this www.medigapquote.org Privacy Policy so you know the importance we place on your privacy and so you can understand how we collect and use information
                        ...
                        you by telephone. By using our service to request information from our advertising clients and advertising partners, you are giving permission to www.medigapquote.org and these
                        parties (or
                        ...
                        <span class="lead">Opt-Out of Receiving Communications from www.medigapquote.org</span>
                        ...
                        This Site may contain links that direct you to websites owned and operated by other companies. www.medigapquote.org does not control or endorse these websites, and we do not
                        assume any
                        ...
                        www.medigapquote.org may change this Privacy Policy at any time. Should we revise this Privacy Policy in the future, we will immediately publish the amended Privacy Policy on our
                        website. We
                        ...
                        Emailing us at: privacy@medigapquote.org <br><br>
        ...
        <div class="reveal" id="terms-of-use" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out">
            <div class="columns row">
                <div class="small-12">
                    ...
                    <hr>
                    <p>The www.medigapquote.org website (“www.medigapquote.org” or the “Site”) is owned and operated by www.medigapquote.org. By using this Site, you signify your assent to these Terms of Use (“Terms” or
                        ...
                        <br><br>
                        www.medigapquote.org may revise and update these Terms at any time. Your continued usage of the Site will mean you accept those changes. <br><br>
            
                        <span class="lead">Use of the Website</span>
                        By using the Site, you represent to www.medigapquote.org that 1) you are authorized to enter into this Agreement and you are at least the age of majority in your state or province
                        of residence;
                        (2) you will not use the Site for any purpose or in any manner that violates any law or regulation or that infringes the rights of www.medigapquote.org or any third party; (3) any
                        information
                        or data provided to www.medigapquote.org by you will not violate any law or regulation or infringe the rights of www.medigapquote.org or any third party; (4) all information that you
                        ...
                        photographs, or other audio, visual, or video elements from the accompanying text or material without the prior express written permission of www.medigapquote.org and/or its
                        ...
                        a person, or otherwise manipulate identifiers in order to disguise your identity or the origin of any message or transmittal you send to www.medigapquote.org on or through the
                        ...
                        negatively impact www.medigapquote.org. The licenses granted by www.medigapquote.org terminate if you do not comply with these Terms. <br><br>
            
                        The material, images, and text on the Site (“Content”) is protected by copyright under both United States and foreign laws. Title to the Content remains with www.medigapquote.org
                        or its
                        ...
                        subject to change or termination without notice in the editorial discretion of www.medigapquote.org. All rights not expressly granted herein are reserved to www.medigapquote.org and its
                        ...
                        jurisdiction of
                        www.medigapquote.org and its suppliers. Accordingly, www.medigapquote.org assumes no liability for or relating to the delay, failure, interruption, or corruption of any data or other
                        ...
                        MOREOVER, www.medigapquote.org MAY MAKE MODIFICATIONS ANY/OR CHANGES ON THIS SITE OR IN THE MATERIALS AND INFORMATION AVAILABLE ON THIS SITE AT ANY TIME AND FOR ANY REASON.
                        www.medigapquote.org MAKES NO REPRESENTATIONS, GUARANTEES, OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE SUITABILITY, COMPLETENESS, TIMELINESS, RELIABILITY, LEGALITY,
                        OR ACCURACY OF
                        THE www.medigapquote.org SERVICES OR THE INFORMATION, CONTENT, MATERIALS, PRODUCTS, OR OTHER SERVICES, OR INCLUDED ON OR OTHERWISE MADE AVAILABLE ON THE SITE. YOU EXPRESSLY AGREE
                        THAT YOUR USE OF THE SITE IS AT YOUR OWN RISK. TO THE FULLEST EXTENT PERMISSIBLE BY APPLICABLE LAW, www.medigapquote.org DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING
                        BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, AND FITNESS FOR PARTICULAR PURPOSE. www.medigapquote.org DOES NOT WARRANT THAT THE INFORMATION,
                        CONTENT, MATERIALS, PRODUCTS OR OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SITE, www.medigapquote.org’s SERVERS, OR ELECTRONIC COMMUNICATIONS SENT
                        FROM www.medigapquote.org ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. www.medigapquote.org ALSO MAKES NO REPRESENTATION, GUARANTEE, OR WARRANTY THAT THIS WEBSITE WILL OPERATE ERROR FREE
                        OR IN AN UNINTERRUPTED FASHION. <br><br>
            
                        To the maximum extent permitted by law, in no event shall www.medigapquote.org, its licensors, its suppliers, or any third parties mentioned on the Site be liable for any damages
                        ...
                        information, Content, materials, or www.medigapquote.org services included on or otherwise made available to you through the Site, whether based in contract, tort, strict
                        liability, or otherwise, and whether or not www.medigapquote.org, its licensors, its suppliers, or any third parties mentioned on the Site have been advised of the possibility of
                        such damages www.medigapquote.org, its licensors, its suppliers, or any third parties mentioned on the Site shall be liable only to the extent of actual damages incurred by you,
                        ...
                        business information, idea, concept or invention to www.medigapquote.org by email, you automatically grant-or warrant that the owner of such content or intellectual property has
                        expressly granted www.medigapquote.org a royalty-free, perpetual, irrevocable, sublicensable world-wide nonexclusive license to use, reproduce, create derivative works from,
                        ...
                        hereafter developed. If you wish to keep any business information, ideas, concepts or inventions private or proprietary, do not submit them to the Site or to www.medigapquote.org
                        by email.<br><br>
            
                        <span class="lead">Advertisements, Searches, and Links to Other Sites</span>
                        www.medigapquote.org may provide links to third-party websites. www.medigapquote.org also may select certain websites as priority responses to search terms you enter and
                        www.medigapquote.org may agree to allow advertisers to respond to certain search terms with advertisements or sponsored content. obamacareusa.org does not endorse the content on
                        any third-party websites. www.medigapquote.org is not responsible for the content of linked third-party sites, sites framed within the Site, third-party websites provided as
                        ...
                        We reserve the right at any time to modify or discontinue the Site (or any part or content thereof) without notice at any time. www.medigapquote.org may add, modify, or delete any
                        ...
                        The AAA Rules are available at www.adr.org or by calling 1-800-778-7879. If you initiate arbitration, www.medigapquote.org will promptly reimburse you for any standard filing fee
                        which may have been required under AAA Rules once you have notified www.medigapquote.org in writing and provided a copy of the arbitration proceedings. However, if www.medigapquote.org is
                        the prevailing party in the arbitration, applicable law may allow the arbitrator to award attorneys’ fees and costs to www.medigapquote.org. If for any reason the AAA is
                        ...
                        ONLY BRING CLAIMS AGAINST www.medigapquote.org IN AN INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS ACTION OR REPRESENTATIVE PROCEEDING.
                        <br><br>
                        ...
                        by contacting www.medigapquote.org’s copyright agent (identified below) and providing the following information: <br><br>
                        ...
                        Email: privacy@medigapquote.org<br><br>
            
                        <span class="lead">Complete Agreement</span>
                        Except as expressly provided in a particular “legal notice” on the Site or via e-mail from www.medigapquote.org, this Agreement and the www.medigapquote.org Privacy Policy constitute the
                        entire agreement between you and www.medigapquote.org with respect to the use of the Site and Content. <br><br>
                        ...
                        &copy; 2016 www.medigapquote.org, All rights reserved.
