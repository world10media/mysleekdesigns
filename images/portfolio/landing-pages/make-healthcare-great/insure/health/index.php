...
<head>
    ...
    <title>Make HealthCare Great Again - Affordable Healthcare for Everyone - <?php echo $aff_ref; ?></title>

    <meta name="description" content="use makehealthcaregreatagain.com to find top health insurance plans">
    <meta name="keywords" content="health insurance, free health insure quotes">
    <meta name="author" content="makehealthcaregreatagain.com">
                ...
                <div class="small-12 columns hilary-trump-layout">
                        ...
                        <div class="row">
                            ...
                            <div class="small-6 medium-6 columns">
                                <div class="logo-wrapper">
                                    <a href=""><img class="logo" src="../../assets/img/logo.gif" alt="logo"></a>
                                </div>
                            </div>
                            ...
                            <div class="small-6 medium-6 columns text-right">
                                <div class="contact-number-wrapper">
                                    ...
                                    <a href="tel:<?php echo $phone_number; ?>"><span class="temp-number"></span><img class="icon-mobile-phone" src="../../assets/img/icon-phone-blue.svg" alt="phone icon"></a>
                                </div>
                            </div>
                    ...
                    <div class="hero">
                        <div class="row">
                            ...
                            <!-- hero - content and hilary trump img -->
                            <div class="small-12 medium-6 large-7 columns end">
                                <div class="hero-content">
                                    <h1 class="hero-header">No matter who wins you will pay</h1>
                                    <h1 class="hero-header-two"><span class="header-callout-high-rates">high health insurance rates.</span></h1>
                                    <h2 class="hero-callout-obamacare">Thanks Obamacare!!!</h2>
                                    <h3 class="hero-callout-beat-rates">Beat the rate increase!<span class="hero-callout-get-insured">Get covered today before Clinton or Trump raise your rates again!</span>
                                    </h3>
                                </div>
                                <div class="hilary-trump-img show-for-medium">
                                    <img class="" src="../../assets/img/hilary-trump-trans-min.png" alt="hilary trump charicatures">
                                </div>
                            </div>
                    
                            <!-- hero - form and phone cta -->
                            <div class="small-12 medium-6 large-5 columns short-form">
                    
                                <div class="contact-form-header-container">
                                    <p class="contact-form-header">Start Your Free Quote!</p>
                                </div>
                    
                                <div class="form-container">
                                    <form class="contact-form" id="short-form" name="form1" role="form"
                                          action="../../assets/php/process2.php"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="small-12 columns">
                                                <label>
                                                    <input type="text" name="zipcode" required id="hero-zip-submit-input"
                                            ...
                                            <div class="small-12 columns">
                                                <button class="button success large form-button" type="submit">View Plans</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    
                                <div class="cta-phone-module">
                                    <span class="cta-phone-module-header">Call Us Today</span>
                                    <a><span class="cta-phone-module-number"><img class="icon-mobile-phone" src="../../assets/img/icon-phone-blue.svg" alt="phone icon"><?php echo $phone_number; ?></span></a>
                                </div>
                    ...
                    <div class="footer">
                        <div class="row">
                            <div class="small-12 medium-8 columns footer-copyright">Copyright &copy; Make HealthCare Great Again, All rights reserved.</div>
                            ...
                            <div class="reveal" id="privacy-policy" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out">
                                <div class="row">
                                    <div class="small-12 columns">
                                        ...
                                        <p class="modal-body">Make HealthCare Great Again, through its www.makehealthcaregreatagain.com website (“Site”) is committed to ensuring the privacy and security of each user that visits our
                                            ...
                                            We have established this www.makehealthcaregreatagain.com Privacy Policy so you know the importance we place on your privacy and so you can understand how we collect and use information
                                            ...
                                            you by telephone. By using our service to request information from our advertising clients and advertising partners, you are giving permission to www.makehealthcaregreatagain.com and these
                                            parties (or
                                            ...
                                            <span class="lead">Opt-Out of Receiving Communications from www.makehealthcaregreatagain.com</span>
                                            ...
                                            This Site may contain links that direct you to websites owned and operated by other companies. www.makehealthcaregreatagain.com does not control or endorse these websites, and we do not
                                            assume any
                                            ...
                                            www.makehealthcaregreatagain.com may change this Privacy Policy at any time. Should we revise this Privacy Policy in the future, we will immediately publish the amended Privacy Policy on our
                                            website. We
                                            ...
                                            Emailing us at: privacy@makehealthcaregreatagain.com <br><br>
                            ...
                            <div class="reveal" id="terms-of-use" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out">
                                <div class="row">
                                    <div class="small-12 columns">
                                        ...
                                        <p class="modal-body">The www.makehealthcaregreatagain.com website (“www.makehealthcaregreatagain.com” or the “Site”) is owned and operated by www.makehealthcaregreatagain.com. By
                                            ...
                                            PLEASE READ THESE TERMS CAREFULLY.<strong> THEY CONTAIN A MANDATORY ARBITRATION PROVISION AND CLASS ACTION
                                                WAIVER.</strong>
                                            <br><br>
                                            www.makehealthcaregreatagain.com may revise and update these Terms at any time. Your continued usage of the Site will mean you
                                            accept those changes. <br><br>
                                
                                            <span class="lead">Use of the Website</span>
                                            By using the Site, you represent to www.makehealthcaregreatagain.com that 1) you are authorized to enter into this Agreement and
                                            ...
                                            infringes the rights of www.makehealthcaregreatagain.com or any third party; (3) any
                                            information
                                            or data provided to www.makehealthcaregreatagain.com by you will not violate any law or regulation or infringe the rights of www.makehealthcaregreatagain.com or any third party; (4) all information that you
                                            ...
                                            prior express written permission of www.makehealthcaregreatagain.com and/or its
                                            ...
                                            message or transmittal you send to www.makehealthcaregreatagain.com on or through the
                                            ...
                                            negatively impact www.makehealthcaregreatagain.com. The licenses granted by www.makehealthcaregreatagain.com terminate if you do not comply with these
                                            Terms. <br><br>
                                
                                            The material, images, and text on the Site (“Content”) is protected by copyright under both United States
                                            and foreign laws. Title to the Content remains with www.makehealthcaregreatagain.com
                                            or its
                                            ...
                                            subject to change or termination without notice in the editorial discretion of www.makehealthcaregreatagain.com. All rights not
                                            expressly granted herein are reserved to www.makehealthcaregreatagain.com and its
                                            ...
                                            jurisdiction of
                                            www.makehealthcaregreatagain.com and its suppliers. Accordingly, www.makehealthcaregreatagain.com assumes no liability for or relating to the delay,
                                            ...
                                            MOREOVER, www.makehealthcaregreatagain.com MAY MAKE MODIFICATIONS ANY/OR CHANGES ON THIS SITE OR IN THE MATERIALS AND INFORMATION
                                            AVAILABLE ON THIS SITE AT ANY TIME AND FOR ANY REASON.
                                            www.makehealthcaregreatagain.com MAKES NO REPRESENTATIONS, GUARANTEES, OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE
                                            SUITABILITY, COMPLETENESS, TIMELINESS, RELIABILITY, LEGALITY,
                                            OR ACCURACY OF
                                            THE www.makehealthcaregreatagain.com SERVICES OR THE INFORMATION, CONTENT, MATERIALS, PRODUCTS, OR OTHER SERVICES, OR INCLUDED ON
                                            OR OTHERWISE MADE AVAILABLE ON THE SITE. YOU EXPRESSLY AGREE
                                            THAT YOUR USE OF THE SITE IS AT YOUR OWN RISK. TO THE FULLEST EXTENT PERMISSIBLE BY APPLICABLE LAW, www.makehealthcaregreatagain.com DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING
                                            BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, AND FITNESS FOR PARTICULAR
                                            PURPOSE. www.makehealthcaregreatagain.com DOES NOT WARRANT THAT THE INFORMATION,
                                            CONTENT, MATERIALS, PRODUCTS OR OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE
                                            SITE, www.makehealthcaregreatagain.com’s SERVERS, OR ELECTRONIC COMMUNICATIONS SENT
                                            FROM www.makehealthcaregreatagain.com ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. www.makehealthcaregreatagain.com ALSO MAKES NO REPRESENTATION,
                                            GUARANTEE, OR WARRANTY THAT THIS WEBSITE WILL OPERATE ERROR FREE
                                            OR IN AN UNINTERRUPTED FASHION. <br><br>
                                
                                            To the maximum extent permitted by law, in no event shall www.makehealthcaregreatagain.com, its licensors, its suppliers, or any
                                            ...
                                            information, Content, materials, or www.makehealthcaregreatagain.com services included on or otherwise made available to you
                                            through the Site, whether based in contract, tort, strict
                                            liability, or otherwise, and whether or not www.makehealthcaregreatagain.com, its licensors, its suppliers, or any third parties
                                            mentioned on the Site have been advised of the possibility of
                                            such damages www.makehealthcaregreatagain.com, its licensors, its suppliers, or any third parties mentioned on the Site shall be
                                            ...
                                            business information, idea, concept or invention to www.makehealthcaregreatagain.com by email, you automatically grant-or warrant
                                            that the owner of such content or intellectual property has
                                            expressly granted www.makehealthcaregreatagain.com a royalty-free, perpetual, irrevocable, sublicensable world-wide nonexclusive
                                            ...
                                            proprietary, do not submit them to the Site or to www.makehealthcaregreatagain.com
                                            by email.<br><br>
                                
                                            <span class="lead">Advertisements, Searches, and Links to Other Sites</span>
                                            www.makehealthcaregreatagain.com may provide links to third-party websites. www.makehealthcaregreatagain.com also may select certain websites as priority
                                            responses to search terms you enter and
                                            www.makehealthcaregreatagain.com may agree to allow advertisers to respond to certain search terms with advertisements or sponsored
                                            content. obamacareusa.org does not endorse the content on
                                            any third-party websites. www.makehealthcaregreatagain.com is not responsible for the content of linked third-party sites, sites
                                            ...
                                            notice at any time. www.makehealthcaregreatagain.com may add, modify, or delete any
                                            ...
                                            The AAA Rules are available at www.adr.org or by calling 1-800-778-7879. If you initiate arbitration, www.makehealthcaregreatagain.com will promptly reimburse you for any standard filing fee
                                            which may have been required under AAA Rules once you have notified www.makehealthcaregreatagain.com in writing and provided a copy
                                            of the arbitration proceedings. However, if www.makehealthcaregreatagain.com is
                                            the prevailing party in the arbitration, applicable law may allow the arbitrator to award attorneys’ fees
                                            and costs to www.makehealthcaregreatagain.com. If for any reason the AAA is
                                            ...
                                            ONLY BRING CLAIMS AGAINST www.makehealthcaregreatagain.com IN AN INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY
                                            ...
                                            by contacting www.makehealthcaregreatagain.com’s copyright agent (identified below) and providing the following information:
                                            <br><br>
                                            ...
                                            Email: privacy@www.makehealthcaregreatagain.com<br><br>
                                
                                            <span class="lead">Complete Agreement</span>
                                            Except as expressly provided in a particular “legal notice” on the Site or via e-mail from www.makehealthcaregreatagain.com, this
                                            Agreement and the www.makehealthcaregreatagain.com Privacy Policy constitute the
                                            entire agreement between you and www.makehealthcaregreatagain.com with respect to the use of the Site and Content. <br><br>
                                            ...
                                            &copy; 2016 www.makehealthcaregreatagain.com, All rights reserved.
                                        </p>
                                        <a class="button large close-modal" data-close>Close</a>
