...
function copy() {
    return gulp.src(PATHS.assets)
        ...
        .pipe(gulp.dest('../usamedsupp.org/assets'));
}
...
function sass() {
    return gulp.src('src/assets/scss/app.scss')
        ...
        .pipe(gulp.dest('../usamedsupp.org/assets/css'))
...
.pipe($.if(!PRODUCTION, $.sourcemaps.write()))
        .pipe(gulp.dest('../usamedsupp.org/assets/js'));
...
function images() {
    return gulp.src('src/assets/img/**/*')
        ...
        .pipe(gulp.dest('../usamedsupp.org/assets/img'));
}
