...
<head>
    ...
    <title>Unsubscribe from PremiumHealthQuotes.com</title>
...
<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-offset-3 panel panel-default">
				...
				<!--<h1 class="margin-base-vertical">Warning.</h1>-->

				<p class="warning-text"><strong>Warning!</strong> You have requested to unsubscribe from our mailing list.</p>

				<form action="unsub.php" method="post" class="margin-base-vertical">
					<p class="input-group">
						<span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
						<input type="email" class="form-control input-lg" id="email" name="email" placeholder="Enter Your Email Address" required value="<?php echo $email; ?>"/>
					</p>
